...
table_demographics <- baseline_data %>% 
    select(stratum, age_int, age_category, height, weight, BMI, sex, genotype, sweat_chlorine_level, CFTR_sweat_chlorine_level, pancreatic_insufficiency, cf_diab, ppfev_365, ppfev_180)%>%
    ...
    mutate(CFTR_sweat_chlorine_level = case_when(CFTR_sweat_chlorine_level == "<40" ~ "<40",
                                            CFTR_sweat_chlorine_level == "40-<60" ~ "40-<60",
                                            CFTR_sweat_chlorine_level == ">=60" ~ "≥60",
                                            CFTR_sweat_chlorine_level == "Missing" ~ "Missing")) %>%  
    ...
    label=list(
      ...
      CFTR_sweat_chlorine_level~"People on CFTR modulators",
