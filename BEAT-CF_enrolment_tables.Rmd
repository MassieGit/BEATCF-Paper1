...
table_microbiology <- microbiology %>%
    select(
      stratum,
      Pseudomonas_species, 
      Staphylococcus_species__MRSA_,
      Staphylococcus_species__MSSA_,
      Staphylococcus_species__Unknown_,
      Haemophilus_species,
    ...
    tbl_summary(
      ...
      label=list(
        ...
        Staphylococcus_species__MRSA_ ~ "Staphylococcus species (MRSA)",
        Staphylococcus_species__MSSA_ ~ "Staphylococcus species (MSSA)",
        Staphylococcus_species__Unknown_ ~ "Staphylococcus species (Unknown)",
